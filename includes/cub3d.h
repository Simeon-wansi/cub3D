...
void    get_wall_texture_dda(t_ray *ray, t_dda *dda, t_player *player, t_dpoint ray_dir);
void    caculate_step_dir_and_side_dist(t_dda *dda, t_player *player, double ray_dir_x, double ray_dir_y);
...
void    calculate_render_properties(t_game *game, int column, t_render *render, t_texture **texture);
void    extract_color_from_texture(t_texture **texture, t_render *render, int index);
